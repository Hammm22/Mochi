...
export default function MochiInfo() {
  return (
    <section
      id="pengertian"
      className="h-screen bg-amber-50 flex flex-col md:flex-row items-center justify-center md:justify-between px-6 md:px-20 py-20 gap-10"
    >
      <motion.h1
        className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-amber-900 w-full md:w-1/2 text-center md:text-left"
      ...
      <motion.p
        className="w-full md:w-1/2 font-semibold text-xl sm:text-2xl md:text-3xl text-stone-800 text-center md:text-left"
